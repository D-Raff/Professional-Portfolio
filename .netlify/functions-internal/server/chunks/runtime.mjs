...
const inlineAppConfig = {
  "nuxt": {
    "buildId": "56a5373e-8371-4bf8-bd1a-4b6983125ecc"
  }
};
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/ctec/Documents/Damon/Professional-Portfolio/.data/kv"}));
...
const _lazy_f1WML2 = () => import('./routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_f1WML2, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_f1WML2, lazy: true, middleware: false, method: undefined }
];
