import { _ as __nuxt_component_0 } from './nuxt-link-C3JAqWzK.mjs';
import { _ as _export_sfc, u as useRoute, a as __nuxt_component_1 } from './server.mjs';
import { gsap as gsap$2 } from 'gsap';
import { watch, mergeProps, withCtx, createVNode, useSSRContext, nextTick } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const updateActiveIndicator = () => {
      nextTick(() => {
        var _a;
        const activeLink = (void 0).querySelector(".nav-link.router-link-exact-active");
        const navIndicator = (void 0).querySelector(".nav-indicator");
        if (activeLink && navIndicator) {
          const linkRect = activeLink.getBoundingClientRect();
          const navRect = (_a = (void 0).querySelector(".nav-links")) == null ? void 0 : _a.getBoundingClientRect();
          if (navRect) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "default-layout" }, _attrs))} data-v-cd4c42f2><nav id="stark-nav" class="stark-navigation" data-v-cd4c42f2><div class="nav-container" data-v-cd4c42f2><div class="nav-brand" data-v-cd4c42f2><div class="brand-logo" data-v-cd4c42f2><div class="logo-core" data-v-cd4c42f2></div><div class="logo-ring" data-v-cd4c42f2></div></div><span class="brand-text" data-v-cd4c42f2>DAMON</span></div><div class="nav-links" data-v-cd4c42f2>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="link-text" data-v-cd4c42f2${_scopeId}>HOME</span><div class="link-glow" data-v-cd4c42f2${_scopeId}></div>`);
          } else {
            return [
              createVNode("span", { class: "link-text" }, "HOME"),
              createVNode("div", { class: "link-glow" })
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="link-text" data-v-cd4c42f2${_scopeId}>WORK &amp; PROJECTS</span><div class="link-glow" data-v-cd4c42f2${_scopeId}></div>`);
          } else {
            return [
              createVNode("span", { class: "link-text" }, "WORK & PROJECTS"),
              createVNode("div", { class: "link-glow" })
            ];
          }
        }),
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="link-text" data-v-cd4c42f2${_scopeId}>CONTACT ME</span><div class="link-glow" data-v-cd4c42f2${_scopeId}></div>`);
          } else {
            return [
              createVNode("span", { class: "link-text" }, "CONTACT ME"),
              createVNode("div", { class: "link-glow" })
            ];
          }
        }),
      ...
      _push(`<div class="nav-indicator" data-v-cd4c42f2><div class="indicator-line" data-v-cd4c42f2></div></div></div></div></nav><div id="Displayed-page" data-v-cd4c42f2>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cd4c42f2"]]);

export { _default as default };
//# sourceMappingURL=default-Dlz9-9lL.mjs.map
